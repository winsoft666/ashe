...
namespace ashe {
WinFileProperty::WinFileProperty() {
    reset();
}

WinFileProperty::~WinFileProperty() {}

bool WinFileProperty::getTranslationId(LPVOID lpData,
                                   UINT unBlockSize,
                                   WORD wLangId,
                                   DWORD& dwId,
...
bool WinFileProperty::open(HMODULE hModule) {
...
bool WinFileProperty::open(const std::wstring& strFileName) {
    reset();
...
WORD WinFileProperty::getFileVersion(int nIndex) const {
    switch (nIndex) {
        case 0:
...
WORD WinFileProperty::getProductVersion(int nIndex) const {
    switch (nIndex) {
        case 0:
...
DWORD WinFileProperty::getFileFlagsMask() const {
    return m_FileInfo.dwFileFlagsMask;
}

DWORD WinFileProperty::getFileFlags() const {
    return m_FileInfo.dwFileFlags;
}

DWORD WinFileProperty::getFileOs() const {
    return m_FileInfo.dwFileOS;
}

DWORD WinFileProperty::getFileType() const {
    return m_FileInfo.dwFileType;
}

DWORD WinFileProperty::getFileSubtype() const {
    return m_FileInfo.dwFileSubtype;
}

std::wstring WinFileProperty::getCompanyName() {
    return m_strCompanyName;
}

std::wstring WinFileProperty::getFileDescription() {
    return m_strFileDescription;
}

std::wstring WinFileProperty::getFileVersion() {
    return m_strFileVersion;
}

std::wstring WinFileProperty::getFileVersionEx() {
...
std::wstring WinFileProperty::getInternalName() {
    return m_strInternalName;
}

std::wstring WinFileProperty::getLegalCopyright() {
    return m_strLegalCopyright;
}

std::wstring WinFileProperty::getOriginalFileName() {
    return m_strOriginalFileName;
}

std::wstring WinFileProperty::getProductName() {
    return m_strProductName;
}

std::wstring WinFileProperty::getProductVersion() {
    return m_strProductVersion;
}

std::wstring WinFileProperty::getComments() {
    return m_strComments;
}

std::wstring WinFileProperty::getLegalTrademarks() {
    return m_strLegalTrademarks;
}

std::wstring WinFileProperty::getPrivateBuild() {
    return m_strPrivateBuild;
}

std::wstring WinFileProperty::getSpecialBuild() {
    return m_strSpecialBuild;
}

FILETIME WinFileProperty::getCreationTime() const {
    return m_ftCreationTime;
}

FILETIME WinFileProperty::getLastAccessTime() const {
    return m_ftLastAccessTime;
}

FILETIME WinFileProperty::getLastWriteTime() const {
    return m_ftLastWriteTime;
}

void WinFileProperty::reset() {
