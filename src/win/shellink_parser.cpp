...
ShellinkParser::ShellinkErr ShellinkParser::load(const std::wstring& lnkPath) {
    ...
    ShellinkParser::ShellinkErr err;
    // HEADER
    {
        //HeaderSize
...
ShellinkParser::ShellinkErr ShellinkParser::readEConsoleDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    ShellinkParser::ShellinkErr err;
...
ShellinkParser::ShellinkErr ShellinkParser::readEConsoleFEDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
...
ShellinkParser::ShellinkErr ShellinkParser::readEDarwinDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    ShellinkParser::ShellinkErr err;
...
ShellinkParser::ShellinkErr ShellinkParser::readEEnvironmentVariableDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    ShellinkParser::ShellinkErr err;
...
ShellinkParser::ShellinkErr ShellinkParser::readEIconEnvironmentDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    ShellinkParser::ShellinkErr err;
...
ShellinkParser::ShellinkErr ShellinkParser::readEKnownFolderDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    ShellinkParser::ShellinkErr err;
...
ShellinkParser::ShellinkErr ShellinkParser::readEPropertyStoreDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    ShellinkParser::ShellinkErr err;
...
ShellinkParser::ShellinkErr ShellinkParser::readEShimDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    ShellinkParser::ShellinkErr err;
...
ShellinkParser::ShellinkErr ShellinkParser::readESpecialFolderDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
...
ShellinkParser::ShellinkErr ShellinkParser::readETrackerDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    ShellinkParser::ShellinkErr err;
...
ShellinkParser::ShellinkErr ShellinkParser::readEVistaAndAboveIDListDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
...
bool ShellinkParser::saveAs(const std::wstring& lnkPath) {
    return true;
}

ShellinkParser::ShellinkErr ShellinkParser::readNULLStr(char** dest, ShellinkParser::ShellinkErr errv1, ShellinkParser::ShellinkErr errv2, FILE* fp) {
    char tmpC = 1;
    uint32_t tmpS = 0;
    while (tmpC != 0) {
...
ShellinkParser::ShellinkErr ShellinkParser::readNULLWStr(wchar_t** dest, ShellinkParser::ShellinkErr errv1, ShellinkParser::ShellinkErr errv2, FILE* fp) {
    char16_t tmpC = 1;
    uint32_t tmpS = 0;
    while (tmpC != 0) {
...
ShellinkParser::ShellinkErr ShellinkParser::readNULLStr(std::vector<char>& dest, ShellinkParser::ShellinkErr errv1, ShellinkParser::ShellinkErr errv2, FILE* fp) {
    char tmpC = 1;
    uint32_t tmpS = 0;
    while (tmpC != 0) {
        if (dest.size() != (tmpS + 1))
...
ShellinkParser::ShellinkErr ShellinkParser::readNULLWStr(std::vector<wchar_t>& dest, ShellinkParser::ShellinkErr errv1, ShellinkParser::ShellinkErr errv2, FILE* fp) {
    char16_t tmpC = 1;
    uint32_t tmpS = 0;
    while (tmpC != 0) {
        if (dest.size() != (tmpS + 1))
...
ShellinkParser::ShellinkErr ShellinkParser::readStr(std::string& dest, ShellinkParser::ShellinkErr errv1, ShellinkParser::ShellinkErr errv2, FILE* fp, size_t size) {
    if (size == 0)
        return (errv1);
...
ShellinkParser::ShellinkErr ShellinkParser::readWStr(std::wstring& dest, ShellinkParser::ShellinkErr errv1, ShellinkParser::ShellinkErr errv2, FILE* fp, size_t size) {
    size /= 2;
    if (size == 0)
        return (errv1);
...
void ShellinkParser::toBigEndian(void* inp, size_t size) {
...
std::wstring ShellinkParser::getDisplayName() const {
    std::wstring result;
    if (linkPath_.empty())
        return result;
    SHFILEINFOW sfi;
...
std::wstring ShellinkParser::getTargetPath() {
    targetPath_.clear();
    std::wstring result;
...
std::wstring ShellinkParser::getWorkingDir() const {
    std::wstring result;
...
std::wstring ShellinkParser::getArguments() const {
    std::wstring result;
...
std::wstring ShellinkParser::getIconPath() const {
    std::wstring result;
    iconIndex_ = 0;
...
int32_t ShellinkParser::getIconIndex() const {
...
bool ShellinkParser::isRunAsAdmin() {
    std::wstring target;
    ...
    Registry regKey(HKEY_CURRENT_USER, L"SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\AppCompatFlags\\Layers");
