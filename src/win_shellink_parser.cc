...
namespace ashe {
WinShellinkParser::ShellinkErr WinShellinkParser::load(const std::wstring& lnkPath) {
    targetPath_.clear();
    linkPath_ = lnkPath;
    FILE* fp = nullptr;
    ...
    WinShellinkParser::ShellinkErr err;
    // HEADER
    {
        //HeaderSize
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEConsoleDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    WinShellinkParser::ShellinkErr err;
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEConsoleFEDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEDarwinDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    WinShellinkParser::ShellinkErr err;
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEEnvironmentVariableDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    WinShellinkParser::ShellinkErr err;
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEIconEnvironmentDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    WinShellinkParser::ShellinkErr err;
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEKnownFolderDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    WinShellinkParser::ShellinkErr err;
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEPropertyStoreDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    WinShellinkParser::ShellinkErr err;
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEShimDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    WinShellinkParser::ShellinkErr err;
...
WinShellinkParser::ShellinkErr WinShellinkParser::readESpecialFolderDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
...
WinShellinkParser::ShellinkErr WinShellinkParser::readETrackerDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
    WinShellinkParser::ShellinkErr err;
...
WinShellinkParser::ShellinkErr WinShellinkParser::readEVistaAndAboveIDListDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp) {
...
bool WinShellinkParser::saveAs(const std::wstring& lnkPath) {
    return true;
}

WinShellinkParser::ShellinkErr WinShellinkParser::readNULLStr(char** dest, WinShellinkParser::ShellinkErr errv1, WinShellinkParser::ShellinkErr errv2, FILE* fp) {
    char tmpC = 1;
    uint32_t tmpS = 0;
    while (tmpC != 0) {
...
WinShellinkParser::ShellinkErr WinShellinkParser::readNULLWStr(wchar_t** dest, WinShellinkParser::ShellinkErr errv1, WinShellinkParser::ShellinkErr errv2, FILE* fp) {
    char16_t tmpC = 1;
    uint32_t tmpS = 0;
    while (tmpC != 0) {
...
WinShellinkParser::ShellinkErr WinShellinkParser::readNULLStr(std::vector<char>& dest, WinShellinkParser::ShellinkErr errv1, WinShellinkParser::ShellinkErr errv2, FILE* fp) {
    char tmpC = 1;
    uint32_t tmpS = 0;
    while (tmpC != 0) {
        if (dest.size() != (tmpS + 1))
...
WinShellinkParser::ShellinkErr WinShellinkParser::readNULLWStr(std::vector<wchar_t>& dest, WinShellinkParser::ShellinkErr errv1, WinShellinkParser::ShellinkErr errv2, FILE* fp) {
    char16_t tmpC = 1;
    uint32_t tmpS = 0;
    while (tmpC != 0) {
        if (dest.size() != (tmpS + 1))
...
WinShellinkParser::ShellinkErr WinShellinkParser::readStr(std::string& dest, WinShellinkParser::ShellinkErr errv1, WinShellinkParser::ShellinkErr errv2, FILE* fp, size_t size) {
    if (size == 0)
        return (errv1);
...
WinShellinkParser::ShellinkErr WinShellinkParser::readWStr(std::wstring& dest, WinShellinkParser::ShellinkErr errv1, WinShellinkParser::ShellinkErr errv2, FILE* fp, size_t size) {
    size /= 2;
    if (size == 0)
        return (errv1);
...
void WinShellinkParser::toBigEndian(void* inp, size_t size) {
...
std::wstring WinShellinkParser::getDescription() const {
    std::wstring result;
...
std::wstring WinShellinkParser::getTargetPath() {
    targetPath_.clear();
    std::wstring result;
    ...
    if (IS_FLAG_SET(header_.LinkFlags, ShllinkLinkFlag::LF_HasLinkTargetIDList)) {
        ...
        if (result.empty()) {  // Not file path
            ...
            if (hr == S_OK) {
                STRRET strret = {0};
                hr = deskFolder->GetDisplayNameOf((PCUITEMID_CHILD)pIDL, SHGDN_FORPARSING, &strret);
                if (hr == S_OK) {
...
std::wstring WinShellinkParser::getWorkingDir() const {
    std::wstring result;
...
std::wstring WinShellinkParser::getArguments() const {
    std::wstring result;
