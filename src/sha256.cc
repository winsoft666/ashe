...
class ashe::SHA256::Private {
   public:
    SHA256_CTX ctx_;
};

ashe::SHA256::SHA256() :
    p_(new ashe::SHA256::Private()) {
}
...
void ashe::SHA256::update(const unsigned char* buffer, uint32_t length) {
    uint32_t left;
...
void ashe::SHA256::digest(unsigned char* s) {
    uint32_t i;
...
std::string ashe::SHA256::GetFileSHA256(const ashe::fs::path& filePath) {
    std::string result;
...
std::string ashe::SHA256::GetDataSHA256(const unsigned char* data, size_t dataSize) {
    SHA256 sha256;
    sha256.init();
...
void ashe::SHA256::sha256_block(const unsigned char* block) {
    uint32_t data[SHA256_DATA_LENGTH];
    uint16_t i;
...
void ashe::SHA256::sha256_transform(uint32_t* state, uint32_t* data) {
