...
#ifndef ASHE_XOR_STR_HPP__
#define ASHE_XOR_STR_HPP__
//
...
#define XORSTRA(s) (ashe::XorStr<char, _countof(s), __COUNTER__>(s, std::make_index_sequence<_countof(s) - 1>()).decrypt())
#define XORSTRW(s) (ashe::XorStr<wchar_t, _countof(s), __COUNTER__>(s, std::make_index_sequence<_countof(s) - 1>()).decrypt())
