...
#ifdef __has_include
#if __has_include(<ashe/optional.tweak.hpp>)
#include <ashe/optional.tweak.hpp>
#endif
...
template <class T>
inline optional_in_place_t opt_in_place(optional_detail::in_place_type_tag<T> /*unused*/ = optional_detail::in_place_type_tag<T>()) {
    return optional_in_place_t();
}

template <std::size_t K>
inline optional_in_place_t opt_in_place(optional_detail::in_place_index_tag<K> /*unused*/ = optional_detail::in_place_index_tag<K>()) {
    return optional_in_place_t();
}

template <class T>
inline optional_in_place_t opt_in_place_type(optional_detail::in_place_type_tag<T> /*unused*/ = optional_detail::in_place_type_tag<T>()) {
    return optional_in_place_t();
}

template <std::size_t K>
inline optional_in_place_t opt_in_place_index(optional_detail::in_place_index_tag<K> /*unused*/ = optional_detail::in_place_index_tag<K>()) {
    return optional_in_place_t();
}

// mimic templated typedef:

#define nonstd_lite_in_place_t(T) ashe::optional_in_place_t (&)(ashe::optional_detail::in_place_type_tag<T>)
#define nonstd_lite_in_place_type_t(T) ashe::optional_in_place_t (&)(ashe::optional_detail::in_place_type_tag<T>)
#define nonstd_lite_in_place_index_t(K) ashe::optional_in_place_t (&)(ashe::optional_detail::in_place_index_tag<K>)

#define nonstd_lite_in_place(T) ashe::opt_in_place_type<T>
#define nonstd_lite_in_place_type(T) ashe::opt_in_place_type<T>
#define nonstd_lite_in_place_index(K) ashe::opt_in_place_index<K>
...
#define optional_CPP11_110_C350_G500 \
    (optional_CPP11_110 &&           \
     !(optional_BETWEEN(optional_COMPILER_CLANG_VERSION, 1, 350) || optional_BETWEEN(optional_COMPILER_GNUC_VERSION, 1, 500)))
...
class optional {
    optional_static_assert((!std::is_same<typename std::remove_cv<T>::type, nullopt_t>::value),
        ...
        optional_static_assert((!std::is_same<typename std::remove_cv<T>::type, optional_in_place_t>::value),
   ...
   public:
    ...
    optional_constexpr explicit optional(nonstd_lite_in_place_t(T), Args&&... args) :
        has_value_(true), contained(opt_in_place, std::forward<Args>(args)...) {}
    ...
    optional_REQUIRES_R(
        optional&,
        std::is_constructible<T, U>::value&& std11::is_assignable<T&, U>::value && !std::is_same<typename std20::remove_cvref<U>::type, nonstd_lite_in_place_t(U)>::value && !std::is_same<typename std20::remove_cvref<U>::type, optional<T> >::value && !(std::is_scalar<T>::value && std::is_same<T, typename std::decay<U>::type>::value))
    operator=(U&& value) {
        if (has_value()) {
    ...
    optional_REQUIRES_R(
        optional&,
        std::is_constructible<T, U const&>::value&& std11::is_assignable<T&, U const&>::value && !std::is_constructible<T, optional<U>&>::value && !std::is_constructible<T, optional<U>&&>::value && !std::is_constructible<T, optional<U> const&>::value && !std::is_constructible<T, optional<U> const&&>::value && !std::is_convertible<optional<U>&, T>::value && !std::is_convertible<optional<U>&&, T>::value && !std::is_convertible<optional<U> const&, T>::value && !std::is_convertible<optional<U> const&&, T>::value && !std11::is_assignable<T&, optional<U>&>::value && !std11::is_assignable<T&, optional<U>&&>::value && !std11::is_assignable<T&, optional<U> const&>::value && !std11::is_assignable<T&, optional<U> const&&>::value)
#else
    optional&
#endif  // optional_CPP11_OR_GREATER
    ...
    optional_REQUIRES_R(
        optional&,
        std::is_constructible<T, U>::value&& std11::is_assignable<T&, U>::value && !std::is_constructible<T, optional<U>&>::value && !std::is_constructible<T, optional<U>&&>::value && !std::is_constructible<T, optional<U> const&>::value && !std::is_constructible<T, optional<U> const&&>::value && !std::is_convertible<optional<U>&, T>::value && !std::is_convertible<optional<U>&&, T>::value && !std::is_convertible<optional<U> const&, T>::value && !std::is_convertible<optional<U> const&&, T>::value && !std11::is_assignable<T&, optional<U>&>::value && !std11::is_assignable<T&, optional<U>&&>::value && !std11::is_assignable<T&, optional<U> const&>::value && !std11::is_assignable<T&, optional<U> const&&>::value)
...
#if optional_CPP11_OR_GREATER
              optional_REQUIRES_T(
                  std11::is_move_constructible<T>::value&& std17::is_swappable<T>::value)
#endif
          >
...
template <class T>
struct hash<ashe::optional<T> > {
   public:
    std::size_t operator()(ashe::optional<T> const& v) const optional_noexcept {
