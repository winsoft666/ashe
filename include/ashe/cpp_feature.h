...
#ifndef CPP_FEATURE_HPP_
#define CPP_FEATURE_HPP_
#pragma once
...
#define HAS_CONSTEXPR14 (__cpp_constexpr >= 201304)
...
#if HAS_CONSTEXPR14 && defined(__clang__)
#define HAS_FULL_FEATURED_CONSTEXPR14 1
#else
#define HAS_FULL_FEATURED_CONSTEXPR14 0
#endif

#endif  // !CPP_FEATURE_HPP_
