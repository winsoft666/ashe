...
#ifndef ASHE_WIN_SHELLINK_PARSER_HPP__
#define ASHE_WIN_SHELLINK_PARSER_HPP__
#pragma once
...
#pragma region LinkInfo
    ...
    struct CommonNetworkRelativeLink {
        ...
        // An optional, NULL�Cterminated, Unicode string that is the Unicode version of the NetName string. This field MUST be present if the value of the NetNameOffset field is greater than 0x00000014; otherwise, this field MUST NOT be present
        std::wstring NetNameUnicode;
        // An optional, NULL�Cterminated, Unicode string that is the Unicode version of the DeviceName string. This field MUST be present if the value of the NetNameOffset field is greater than 0x00000014; otherwise, this field MUST NOT be present
    ...
    struct LinkInfo {
        ...
        // An optional, NULL�Cterminated string, defined by the system default code page, which is used to construct the full path to the link item or link target by appending the string in the CommonPathSuffix field. This field is present if the VolumeIDAndLocalBasePath flag is set
        ...
        // A NULL�Cterminated string, defined by the system default code page, which is used to construct the full path to the link item or link target by being appended to the string in the LocalBasePath field
        std::string CommonPathSuffix;

        // An optional, NULL�Cterminated, Unicode string that is used to construct the full path to the link item or link target by appending the string in the CommonPathSuffixUnicode field. This field can be present only if the VolumeIDAndLocalBasePath flag is set and the value of the LinkInfoHeaderSize field is greater than or equal to 0x00000024
        std::wstring LocalBasePathUnicode;

        // An optional, NULL�Cterminated, Unicode string that is used to construct the full path to the link item or link target by being appended to the string in the LocalBasePathUnicode field. This field can be present only if the value of the LinkInfoHeaderSize field is greater than or equal to 0x00000024
...
#pragma region ExtraData
    ...
    struct DarwinDataBlock {
        ...
        // A NULL�Cterminated string, defined by the system default code page, which specifies an application identifier. This field SHOULD be ignored (260b)
        std::string DarwinDataAnsi;
        // An optional, NULL�Cterminated, Unicode string that specifies an application identifier (In Windows, this is a Windows Installer (MSI) application descriptor. For more information, see [MSDN-MSISHORTCUTS]) (520b)
...
#pragma endregion ExtraData
   ...
   private:
    ShellinkParser::ShellinkErr readEConsoleDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readEConsoleFEDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readEDarwinDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readEEnvironmentVariableDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readEIconEnvironmentDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readEKnownFolderDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readEPropertyStoreDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readEShimDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readESpecialFolderDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readETrackerDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    ShellinkParser::ShellinkErr readEVistaAndAboveIDListDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
...
#endif  // !ASHE_WIN_SHELLINK_PARSER_HPP__