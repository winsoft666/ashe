...
//
namespace ashe {
class ASHE_API WinShellinkParser {
   public:
...
#pragma endregion ExtraData
   ...
   private:
    ...
    WinShellinkParser::ShellinkErr readEDarwinDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    WinShellinkParser::ShellinkErr readEEnvironmentVariableDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    WinShellinkParser::ShellinkErr readEIconEnvironmentDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    WinShellinkParser::ShellinkErr readEKnownFolderDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    WinShellinkParser::ShellinkErr readEPropertyStoreDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    WinShellinkParser::ShellinkErr readEShimDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    WinShellinkParser::ShellinkErr readESpecialFolderDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    WinShellinkParser::ShellinkErr readETrackerDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
    WinShellinkParser::ShellinkErr readEVistaAndAboveIDListDataBlock(uint32_t blockSize, uint32_t blockSignature, FILE* fp);
