...
TEST_CASE("Shellink1", "load Postman.lnk") {
    ...
    ashe::WinShellinkParser::ShellinkErr err = wsl.load(LR"(.\win_lnks\Postman.lnk)");
...
TEST_CASE("Shellink2", "load 'Shows Desktop.lnk'") {
    ashe::WinShellinkParser wsl;
    ashe::WinShellinkParser::ShellinkErr err = wsl.load(LR"(.\win_lnks\Shows Desktop.lnk)");
    CHECK(err == ashe::WinShellinkParser::ShellinkErr::SHLLINK_ERR_NONE);

    std::wstring displayName = wsl.getDescription();
    if (ashe::WinShellinkParser::IsResourceString(displayName)) {
        std::wstring ret;
        if (ashe::WinShellinkParser::LoadStringFromRes(displayName, ret))
            displayName = ret;
    }
    CHECK(displayName == LR"(��ʾ����)");
...
TEST_CASE("Shellink3", "load VMCreate.lnk") {
    ashe::WinShellinkParser wsl;
    ashe::WinShellinkParser::ShellinkErr err = wsl.load(LR"(.\win_lnks\VMCreate.lnk)");
    CHECK(err == ashe::WinShellinkParser::ShellinkErr::SHLLINK_ERR_NONE);
...
TEST_CASE("Shellink4", "load computer.lnk") {
    ashe::WinShellinkParser wsl;
    ashe::WinShellinkParser::ShellinkErr err = wsl.load(LR"(.\win_lnks\computer.lnk)");
    CHECK(err == ashe::WinShellinkParser::ShellinkErr::SHLLINK_ERR_NONE);
...
#ifdef ASHE_WIN64
    ashe::WinShellinkParser wsl;
    ashe::WinShellinkParser::ShellinkErr err = wsl.load(LR"(.\win_lnks\Math Input Panel.lnk)");
    CHECK(err == ashe::WinShellinkParser::ShellinkErr::SHLLINK_ERR_NONE);
